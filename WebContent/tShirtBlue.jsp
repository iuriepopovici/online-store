...
itemCart.setItemId(1);
itemCart.setNbItems(80);
itemCart.setItemPrice(7.99); 
itemCart.setColor("blue");
itemCart.setSku("sk10001");
itemCart.setWeight(1.0);
itemCart.setImgSm("img/merch/tshirt_logo_blue_128.png");
itemCart.setImgMd("img/merch/tshirt_logo_blue_256.png");
itemCart.setImgLg("img/merch/tshirt_logo_blue_720.png");
%>
