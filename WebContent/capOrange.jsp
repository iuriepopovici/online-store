...
itemCart.setItemId(4);
itemCart.setNbItems(30);
itemCart.setItemPrice(12.99); 
itemCart.setColor("orange");
itemCart.setSku("sk20022");
itemCart.setWeight(1.2);
itemCart.setImgSm("img/merch/cap_logo_orange_128.png");
itemCart.setImgMd("img/merch/cap_logo_orange_256.png");
itemCart.setImgLg("img/merch/cap_logo_orange_720.png");
%>
