...
itemCart.setItemId(5);
itemCart.setNbItems(40);
itemCart.setItemPrice(9.99); 
itemCart.setColor("blue");
itemCart.setSku("sk30031");
itemCart.setWeight(1.8);
itemCart.setImgSm("img/merch/mug_logo_blue_128.png");
itemCart.setImgMd("img/merch/mug_logo_blue_256.png");
itemCart.setImgLg("img/merch/mug_logo_blue_720.png");
%>
